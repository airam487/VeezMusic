...
async def play(_, message: Message):
    ...
    if audio:
        ...
        try:
            ...
            thumb_name = f"thumb-{title}-https://telegra.ph/file/895bfecd37c2676860eff.jpg.jpg"
...
async def lol_cb(b, cb):
    ...
    try:
        ...
        thumb_name = f"thumb-{title}https://telegra.ph/file/895bfecd37c2676860eff.jpg"
